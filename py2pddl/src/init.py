...
def init(filename):
    ...
    # Type of action
    Type_action = input("For action insert 1; For durative-action insert 2: ")
    Type_action = sanitise(Type_action)
    Type_action = Type_action[0].upper() + Type_action[1:]

    print("Action type", Type_action)
